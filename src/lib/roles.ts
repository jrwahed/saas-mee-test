...
export const DEFAULT_ACCESS: Record<AppRole, string[]> = {
  super_admin: ["/", "/ai-brain", "/ai-performance-marketing", "/campaigns", "/crm", "/tasks", "/sales", "/sales-pipeline", "/reports", "/competitors", "/users", "/admin-onboard"],
  owner: ["/", "/ai-brain", "/ai-performance-marketing", "/campaigns", "/crm", "/tasks", "/sales", "/sales-pipeline", "/reports", "/competitors", "/users"],
  sales_manager: ["/", "/ai-brain", "/crm", "/tasks", "/sales", "/sales-pipeline", "/reports"],
  marketing_manager: ["/", "/ai-brain", "/ai-performance-marketing", "/campaigns", "/tasks", "/reports", "/competitors"],
  team_leader: ["/", "/crm", "/tasks", "/sales", "/reports"],
  sales_rep: ["/crm"],
  viewer: ["/"],
};
